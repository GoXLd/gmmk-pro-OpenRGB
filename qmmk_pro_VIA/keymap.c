...
bool rgb_matrix_indicators_user(void)
{
	...
	rgb_matrix_set_color(7, 127, 55, 18);	 // 1		rgb(127, 55, 18)
	rgb_matrix_set_color(13, 127, 55, 18); // 2		rgb(127, 55, 18)
	rgb_matrix_set_color(19, 127, 55, 18); // 3		rgb(127, 55, 18)
	rgb_matrix_set_color(24, 127, 55, 18); // 4		rgb(127, 55, 18)
	rgb_matrix_set_color(29, 127, 55, 18); // 5		rgb(127, 55, 18)
	rgb_matrix_set_color(35, 127, 55, 18); // 6		rgb(127, 55, 18)
	rgb_matrix_set_color(40, 127, 55, 18); // 7		rgb(127, 55, 18)
	rgb_matrix_set_color(45, 127, 55, 18); // 8		rgb(127, 55, 18)
	rgb_matrix_set_color(51, 127, 55, 18); // 9		rgb(127, 55, 18)
	rgb_matrix_set_color(57, 127, 55, 18); // 0		rgb(127, 55, 18)
	rgb_matrix_set_color(62, 127, 55, 18); // -_		rgb(127, 55, 18)
	rgb_matrix_set_color(78, 127, 55, 18); // =+		rgb(127, 55, 18)
